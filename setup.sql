...
-- 2. ✅ Created normalized customers table with demographics
-- 3. ✅ Created loans table with generated dates and terms
-- 4. ✅ Created defaults table for defaulted loans only
-- 5. ✅ Added primary keys, foreign keys, and check constraints
-- 6. ✅ Created indexes for query performance
-- 7. ✅ Built a view to simplify future queries
-- 8. ✅ Verified data integrity with multiple checks
-- 
-- Your database now has:
-- - ~32,000 customers
-- - ~32,000 loans
-- - ~6,400 defaults (20% default rate)
-- - Proper relationships between all tables
-- - Indexes for fast queries
-- 
-- Next steps:
-- 1. Review the verification queries above
--    - Check that row counts make sense
--    - Ensure integrity checks all show 0
--    - Look at default rates by grade
-- 
-- 2. Ready for 02_analysis_queries.sql
--    - This is where the real analysis happens!
--    - 7 impressive queries showcasing your SQL skills
--    - Risk scoring, cohort analysis, segmentation, and more
-- 
-- 3. Then 03_powerbi_export.sql
--    - Export data for Power BI dashboards
-- 
-- Questions about anything you just ran? Let me know!
-- =============================================================================